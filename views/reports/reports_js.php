...
?>
	 ...
	 */
	 function switchViews(view)
	 {
		...
		$("#reports-box1 .report-list-toggle a").parent().removeClass("active");
	...
	{
		$("#reports-box1 .report-list-toggle a").click(function(){
			...
			function(data) {
				if (data != null && data != "" && data.length > 0) {
					...
					setTimeout(function(){
						...
						{
							switchViews($("#reports-box1 .report-list-toggle a.map"));
						}
