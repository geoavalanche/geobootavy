...
<!-- filters-box -->
				<div class="span3" style="padding:10px 5px 10px 0">
					...
					<div id="sidebar">
						<ul style="display: block;">
							...
							<li class="submenu">
								<a href="#"><i class="icon icon-th-list"></i> <span><?php echo Kohana::lang('ui_main.category')?></span></a>
							...
							<li class="submenu">
								<a class="f-title" href="#"><i class="icon icon-globe"></i> <span><?php echo Kohana::lang('ui_main.location'); ?></span></a>
								<ul>
									<li>
										<div class="f-location-box"><?php echo $alert_radius_view; ?></div>
									</li>
								</ul>
							</li>
							
							<li class="submenu">
								<a class="f-title" href="#"><i class="icon icon-random"></i> <span><?php echo Kohana::lang('ui_main.type')?></span></a>
							...
							<li class="submenu">
								<a class="f-title" href="#"><i class="icon icon-desktop"></i> <span><?php echo Kohana::lang('ui_main.media');?></span></a>
							...
							<li class="submenu">
								<a class="f-title" href="#"><i class="icon icon-check"></i> <span><?php echo Kohana::lang('ui_main.verification'); ?></span></a>
							...
							<li class="submenu">
								<a class="f-title" href="#"><i class="icon icon-magic"></i> <span><?php echo Kohana::lang('ui_main.custom_fields'); ?></span></a>
								<ul>
					...
					<b><?php echo Kohana::lang('ui_main.filter_reports_by'); ?></b>
					<div id="accordion">
